                                ...
                                <tr >
                                    ...
                                    <td class="text-center">
                                        <div style="display: flex; justify-content:space-around;">
                                            @if ($myorder->delivary_status == 1)
                                            <a href="{{ route('delivarystatus',$myorder->id) }}" style="margin: 0px 5px;" class="btn btn-sm btn-success">Delivered</a>
                                            @else
                                            <a href="{{ route('delivarystatus',$myorder->id) }}" style="margin: 0px 5px;" class="btn btn-sm btn-info">Not Delivered</a>
                                            @endif
                                        </div>
                                    </td>
                                </tr>
