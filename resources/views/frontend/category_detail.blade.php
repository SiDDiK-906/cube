            ...
            <div class="row">
                <div class="col-lg-9 order-lg-last col-md-12 order-md-first">
                    ...
                    <div class="shop-top-bar d-flex">
                        <!-- Left Side start -->
                        <p><span>{{ $all_category_data->count() }}</span> Product Found of <span>{{ $count_all_product }}</span></p>
                        <!-- Left Side End -->
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="shop-grid">
                                        <div class="row mb-n-30px">
                                            @forelse ($all_category_data as $product)
                                                        ...
                                                        <div class="product">
                                                            <div class="thumb">
                                                                <a href="single-product.html" class="image">
                                                                    <img src="{{ asset('uploads/product_pic') }}/{{ $product->image }}"
                                                                        alt="Product" />
