...
<html>
    <head>
        ...
        <link href="{{ asset('dashboard') }}/assets/css/5starrating.css" rel="stylesheet" type="text/css" />
    ...
    <body>
        ...
        <div id="wrapper">
                ...
                <div class="slimscroll-menu" id="remove-scroll">
                    ...
                    <div class="topbar-left">
                        <div class="logo" style="display: flex">
                            ...
                            <a href="{{ route('front_page') }}"><img src="{{ asset('frontend') }}/assets/images/logo/cube.png" width="50px" alt="Site Logo" /></a>
                        </div>
                    </div>
                    <!-- User box -->
                    <div class="user-box pb-0">
                        <div class="user-img">
                            <img src="{{ asset('uploads/profile_pic').'/'.Auth::user()->profile_photo }}" alt="user-img" title="Mat Helme" class="rounded-circle img-fluid">
                        </div>
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                <a href="{{ url('/') }}">
                                    <i class="fa fa-code" style="font-size: 22px"></i><span class="badge badge-danger badge-pill pull-right">7</span> <span> Index </span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('http://localhost/phpmyadmin/db_structure.php?server=1&db=cube') }}">
                                    <i class="fa fa-database" style="font-size: 22px"></i><span class="badge badge-danger badge-pill pull-right">7</span> <span> Database </span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('home') }}">
                                    <i class="fa fa-home" style="font-size: 22px"></i><span class="badge badge-danger badge-pill pull-right">7</span> <span> Home </span>
                                </a>
                            </li>
                            @if (Auth::user()->role == 2)
                                <li>
                                ...
                                <li>
                                    <a href="javascript: void(0);"><i class="fa fa-map-marker"></i><span> Location </span> <span class="menu-arrow"></span></a>
                                    <ul class="nav-second-level" aria-expanded="false">
                                        <li><a href="{{ route('location') }}">Add Location</a></li>
                                        <li><a href="{{ route('location_view') }}">View Location</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="{{ route('email_offer') }}"><i class="fa fa-envelope"></i><span class="badge badge-info pull-right">11</span><span> Email Offer </span></a>

                                </li>
                                <li>
                                    <a href="javascript: void(0);"><i class="fa fa-percent"></i><span> Coupon </span> <span class="menu-arrow"></span></a>
                                    <ul class="nav-second-level" aria-expanded="false">
                                        <li><a href="{{ route('coupon.create') }}">Add Coupon</a></li>
                                        <li><a href="{{ route('coupon.index') }}">View Coupon</a></li>
                                        <li><a href="#">Trash Coupon</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="javascript: void(0);"><i class="fi-paper-stack"></i><span> Banner </span> <span class="menu-arrow"></span></a>
                                    <ul class="nav-second-level" aria-expanded="false">
                                        <li><a href="{{ route('banner.create') }}">Add Banner</a></li>
                                        <li><a href="{{ route('banner.index') }}">View Banner</a></li>
                                        <li><a href="#">Trash Banner</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="javascript: void(0);"><i class="fa fa-industry"></i><span> Vendor </span> <span class="menu-arrow"></span></a>
                                    <ul class="nav-second-level" aria-expanded="false">
                                        <li><a href="{{ route('vendor.create') }}">Add Vendor</a></li>
                                        <li><a href="{{ route('vendor.index') }}">View Vendor</a></li>
                                        <li><a href="#">Trash Vendor</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="javascript: void(0);"><i class="fi-paper-stack"></i><span> Category </span> <span class="menu-arrow"></span></a>
                                    <ul class="nav-second-level" aria-expanded="false">
                                        <li><a href="{{ route('category.create') }}">Add Category</a></li>
                                        <li><a href="{{ route('category.index') }}">View Category</a></li>
                                        <li><a href="{{ route('trash') }}">Trash Category</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="javascript: void(0);"><i class="fa fa-truck"></i><span class="badge badge-danger pull-right">{{ orders_info() }}</span> <span> All Orders </span></a>
                                    <ul class="nav-second-level" aria-expanded="false">
                                        <li><a href="{{ route('allOrders') }}">View Orders</a></li>
                                    </ul>
                                </li>
                            @endif
                            @if (Auth::user()->role == 3)
                                <li>
                                    <a href="javascript: void(0);"><i class="fa fa-industry"></i><span> Product </span> <span class="menu-arrow"></span></a>
                                    <ul class="nav-second-level" aria-expanded="false">
                                        <li><a href="{{ route('product.create') }}">Add Product</a></li>
                                        <li><a href="{{ route('product.index') }}">View Product</a></li>
                                        <li><a href="#">Trash Product</a></li>
                                    </ul>
                                </li>
                            @endif
                            @if (Auth::user()->role == 1)
                                <li>
                                    <a href="javascript: void(0);"><i class="fa fa-truck"></i><span class="badge badge-danger pull-right">{{ orders_info() }}</span> <span> My Orders </span></a>
                                    <ul class="nav-second-level" aria-expanded="false">
                                        <li><a href="{{ route('myorders') }}">View Orders</a></li>
                                    </ul>
                                </li>
                            @endif
            ...
            <div class="content-page">
                        ...
                        <ul class="list-unstyled topbar-right-menu float-right mb-0">
                            ...
                            <li class="dropdown notification-list">
                                <a class="nav-link dropdown-toggle nav-user" data-toggle="dropdown" href="#" role="button"
                                   aria-haspopup="false" aria-expanded="false">
                                    <img src="{{ asset('uploads/profile_pic').'/'.Auth::user()->profile_photo }}" alt="user" class="rounded-circle"> <span class="ml-1">{{ Auth::user()->name }}<i class="mdi mdi-chevron-down"></i> </span>
                                </a>
                ...
                <footer class="footer text-right">
                    {{ \Carbon\Carbon::today()->format('Y') }} © SiD. - www.cube.com
                </footer>
        ...
        {{-- Select all checkbox plugin --}}
        @yield('check_box')
        @yield('location_index')
